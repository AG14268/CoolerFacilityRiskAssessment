...
class ExpandTableViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    override func awakeFromNib() {
        ...
        segmentedCtrl.setTitleTextAttributes([NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 13.0)], for: UIControl.State.selected)
        segmentedCtrl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor : UIColor.white], for: UIControl.State.selected)
    ...
    func configure(_ area: AreaInfo) {
        ...
        case.acceptable:
            ...
            segmentedCtrl.selectedSegmentTintColor = UIColor.init(red: 0.0, green: 0.5, blue: 0.0, alpha: 0.8)
        case.unacceptable:
            segmentedCtrl.selectedSegmentIndex = 1
            segmentedCtrl.selectedSegmentTintColor = UIColor.init(red: 0.5, green: 0.0, blue: 0.0, alpha: 0.8)
        case.notAvailable:
